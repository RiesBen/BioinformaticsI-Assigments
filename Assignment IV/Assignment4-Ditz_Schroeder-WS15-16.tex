...
\begin{figure}[ht]
 ...
 \begin{tabular}{c|ccc}
  ...
  \hline
  \textbf{BB11007} & $c_{1,1}$ & $c_{2,1}$ & $c_{3,1}$ \\
  \textbf{BB20002} & $c_{1,2}$ & $c_{2,2}$ & $c_{3,2}$ \\
  \textbf{Prolyl-tRNA} & $c_{1,3}$ & $c_{2,3}$ & $c_{3,3}$ \\
 \end{tabular}}
 \caption{total column score of all used programs for example files}
 \label{totCol}
\end{figure}
...
\begin{figure}[ht]
 ...
 \begin{tabular}{c|ccc}
  ...
  \hline
  \textbf{BB11007} & $s_{1,1}$ & $s_{2,1}$ & $s_{3,1}$ \\
  \textbf{BB20002} & $s_{1,2}$ & $s_{2,2}$ & $s_{3,2}$ \\
  \textbf{Prolyl-tRNA} & $s_{1,3}$ & $s_{2,3}$ & $s_{3,3}$ \\
 \end{tabular}}
 \caption{sum-of-pairs score of all used programs for example files}
 \label{SPscore}
\end{figure}
...
\begin{figure}[ht]
 ...
 \begin{tabular}{c|ccc}
  ...
  \hline
  \textbf{BB11007} & $t_{1,1}$ & $t_{2,1}$ & $t_{3,1}$ \\
  \textbf{BB20002} & $t_{1,2}$ & $t_{2,2}$ & $t_{3,2}$ \\
  \textbf{Prolyl-tRNA} & $t_{1,3}$ & $t_{2,3}$ & $t_{3,3}$ \\
 \end{tabular}}
 \caption{runtime of all used programs for example files}
 \label{runtime}
\end{figure}
