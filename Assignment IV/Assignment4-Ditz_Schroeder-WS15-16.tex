...
\noindent If we fill the DP matrix using this recursion, we get the following MSA:
...
The last step was creating the actual MSA. The 'complete alignment' methode 
\begin{figure}[h]
