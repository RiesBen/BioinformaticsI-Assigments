...
\header{11}{Alexander Seitz}{18. January 2016}{Bioinformatics I}{\\Jonas Ditz \\\& Benjamin Schroeder}{WS 15/16}{2}
...
\begin{align}
 S_1 &= AACCGTTAACGTAAACGT \nonumber \\
 S_2 &= AACCGTAAACGTTAACGT \nonumber \\
 S_3 &= AACCGTTAAACGTAACGT \nonumber \\
 S_4 &= AACCGTAACGTTAAACGT \nonumber
\end{align}
...
the resulting de Bruijn graph. But in this case there is one problem. Since there are more than two 
unbalanced nodes in the de bruijn graph there is no Eulerian path.

\begin{figure}[h]
 \centering
 \includegraphics[width=0.7\textwidth]{deBruijnGraph_4mere.png}
