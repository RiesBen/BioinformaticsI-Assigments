...
\subsection*{graphs}
The graphs from the exercise are shown in Figure 1-3. Figure 1 is the overlap grap, Figure 2 is the minimal spanning tree and Figure 3 shows the layout. These figures are also publishable.
 
\begin{figure}[h]
	\includegraphics[width=\textwidth]{overlapGraph.png}
