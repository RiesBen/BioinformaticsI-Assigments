...
Assume two sequences of length t with l mismatches. In the worst case, all mismatches are 
distributed uniformly. Than both sequences will share $l+1$ tuples of length $\lfloor\frac{t}{l+1}\rfloor$.\\
\\
\noindent So both sequences share $l+1$ k-tuples of length $k = \lfloor\frac{t}{l+1}\rfloor$ and for each 
...
\begin{figure}[ht]
 ...
 \caption{feasible region of linear program}
