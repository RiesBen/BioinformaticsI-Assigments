...
POODLE is a software suite which deals with a real problem in a nearly every life science laboratory. Due to the data management aspect of sequences and the task of fast information providing. The background data, which was obtained, is focussed on cloning for protein structure-function-relationship-studies or structure elucidation. Therefore we will focus on this application field.
...
\bibitem[Mülhardt, 2013]{Mülhardt1}
...
Stratagene (2007) QuikChange\textregistered Site-Directed Mutagenesis Kit 
 ...
 \bibitem[Van den Ent {\it et~al}, 2006]{Van den Ent}
