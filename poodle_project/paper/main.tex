...
perform a quick and simply search against NCBI databases, e.g. Swissprot (\citealp{Doni01}). But we do not recommend to 
overuse that because too many requests may cause a blacklisting by NCBI. 
