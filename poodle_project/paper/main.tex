...
\author[Ditz \textit{et~al}.]{Jonas Ditz\,$^{\text{\sfb 1,}*}$ and Benjamin Schroeder\,$^{\text{\sfb 1,}*}$} 
...
\textbf{Results:} POODLE is a Java-based web interface, which allows you to intuitively access, update and 
